<?php
/* Smarty version 4.3.1, created on 2026-05-19 02:45:14
  from 'app:controllersgridsettingscategoryformcategoryForm.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_6a0bceba3356d5_83054768',
...
function content_6a0bceba3356d5_83054768 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
...
ob_start();?>
			<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, 'default', "sampleUrl", null);?>
				<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>\PKP\core\PKPApplication::ROUTE_PAGE,'page'=>"catalog",'op'=>"category",'path'=>"path"),$_smarty_tpl ) );?>
...
" src="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['url'][0], array( array('router'=>\PKP\core\PKPApplication::ROUTE_PAGE,'page'=>"catalog",'op'=>"thumbnail",'type'=>"category",'id'=>$_smarty_tpl->tpl_vars['categoryId']->value),$_smarty_tpl ) );?>
...
$_block_repeat=true;
echo $_block_plugin9->smartyFBVFormSection(array('list'=>true,'title'=>"manager.sections.form.assignEditors"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
		<div><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"manager.categories.form.assignEditors.description"),$_smarty_tpl ) );?>
</div>
		<?php
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"checkbox",'id'=>"subEditors[".((string)$_smarty_tpl->tpl_vars['userGroupId']->value)."][]",'value'=>$_smarty_tpl->tpl_vars['id']->value,'checked'=>((isset($_smarty_tpl->tpl_vars['subeditorUserGroups']->value[$_smarty_tpl->tpl_vars['id']->value])) && in_array($_smarty_tpl->tpl_vars['userGroupId']->value,$_smarty_tpl->tpl_vars['subeditorUserGroups']->value[$_smarty_tpl->tpl_vars['id']->value])),'label'=>$_prefixVariable1,'translate'=>false),$_smarty_tpl ) );?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
		<?php $_block_repeat=false;
echo $_block_plugin9->smartyFBVFormSection(array('list'=>true,'title'=>"manager.sections.form.assignEditors"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
